        ...
        {(props?.type == "heading" || props?.type == "sidebar") && (
          <>
            {props?.type == "sidebar" || props?.isCollapsable ? (
              ...
              <>
                <h2 className="font-medium ml-2 leading-tight text-md mt-0 mb-2 text-gray-400 px-6 ">
                  {props.title}
                </h2>
                {props?.pages.map((pageInfo: any) => {
                  ...
                  return (
                    <Link href={linkUrl + "/" + pageInfo.id}>
                      <div className="text-gray-800 ml-4 py-3 hover:bg-gray-100 hover:cursor-pointer px-6 ">
                        {pageInfo.title}
                      </div>
                    </Link>
                  );
...
function CategoryDropdown({ props, version, linkUrl }: any) {
  ...
  console.log(props, version, linkUrl, props.type);
  return (
