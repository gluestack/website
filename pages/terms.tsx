                  ...
                  <Text>
                    ...
                    <Text style="py-4 ml-8">
                      <ul className="list-disc">
                        ...
                        <li className="py-4">
                          Your visit, access or use of the Services are governed
                          by these Terms of Service (
                          <span className="font-displaySemibold">“Terms”</span>
                          ), so please carefully read them before using the
                          Services. These Terms applies to all visitors, users,
                          and others who access the Services (
                          <span className="font-displaySemibold">
                            “Users”
                          </span>{" "}
                          “you” and/or{" "}
                          <span className="font-displaySemibold">“your”</span>).
                        </li>
                        <li className="py-4">
                          In order to use the Services, you must first agree to
                          these Terms. If you use the Services on behalf of a
                          company, business or other legal entity (each an
                          <span className="font-displaySemibold">“Entity”</span>
                          ) , you are agreeing to these Terms for that Entity
                          and promising that you have the authority to bind that
                          Entity to these Terms. In that case, “you” and “your”
                          will also refer to that Entity, wherever possible.
                        </li>
                        <li className="py-4">
                          Our Services are not intended for use by children
                          under the age of 18 (
                          <span className="font-displaySemibold">“Child”</span>{" "}
                          or{" "}
                          <span className="font-displaySemibold">
                            “Children””
                          </span>{" "}
                          ). By using our Services, you certify that you are a
                          person of at least 18 years of age.
                        </li>
                        <li className="py-4">
                          You agree your purchases and/or use of the Services
                          are not contingent on the delivery of any future
                          functionality or features or dependent on any oral or
                          written public comments made by GeekyAnts Inc., its
                          parent company, group companies or any of its
                        ...
                        <li className="py-4">
                          ...
                          ARBITRATION CLAUSE HEREUNDER, YOU AGREE THAT DISPUTES
                          BETWEEN YOU AND US WILL BE RESOLVED BY MANDATORY
                          BINDING ARBITRATION AND YOU WAIVE ANY RIGHT TO
                          PARTICIPATE IN A CLASS-ACTION LAWSUIT OR CLASS-WIDE
                          ARBITRATION.
                        </li>
                        <li className="py-4">
                          BY USING OR OTHERWISE ACCESSING THE SERVICES OR ANY
                          MATERIALS INCLUDED IN OR WITH THE SERVICES, YOU HEREBY
                          AGREE TO BE BOUND BY THESE TERMS. IF YOU DO NOT ACCEPT
                ...
                <div className="py-4 ml-8">
                  <Text>
                    <p>
                      ...
                      of information, reviews, recommendations, messages,
                      comments, posts, text, graphics, algorithms, software,
                      photographs, videos, data, and other materials ({" "}
                      <span className="font-displaySemibold">“Content”</span>)
                      may be made available through the Services by us (
                      <span className="font-displaySemibold">
                        “Supplied Content”
                      </span>
                      ). While we strive to keep the Content that we provide
                      through our Services accurate, complete, and up-to-date,
                      we cannot guarantee, and are not responsible for the
                      accuracy, completeness, or timeliness of any Supplied
                      Content.
                    </p>
                    <p className="py-4">
                      <span className="font-displaySemibold">b.</span> You
                      acknowledge that you may also be able to upload, post,
                      deliver, provide or otherwise transmit or store
                      information (such as software, code, data,
                      information,feedback, suggestions, text, content and other
                      materials) through use of the Services. All such
                      information shall be referred to as “User Content.”
                    </p>
                    <p className="py-4">
                      <span className="font-displaySemibold">c.</span> You agree
                      that you are solely responsible for (and that we have no
                      responsibility to you or to any third party for) any User
                      Content, and for the consequences of your actions
                      (including any loss or damage which we may suffer) in
                      connection with such User Content. If you are registering
                      for these Services on behalf of an Entity, you also agree
                      that you are also responsible for the actions of
                      associated Users and for any User Content that such
                      associated Users might upload, record, publish, post, link
                      to, or otherwise transmit or distribute through use of the
                      Services. Furthermore, you acknowledge that we do not
                      control or actively monitor Content uploaded by users and,
                      as such, do not guarantee the accuracy, integrity or
                      quality of such Content. You acknowledge that by using the
                      Services, you may be exposed to materials that are
                      offensive, indecent or objectionable. Under no
                      circumstances will GeekyAnts Inc., its parent company,
                      group companies and or affiliates are liable in any way
                      for any such Content.
                    </p>
                    <p className="py-4">
                      <span className="font-displaySemibold">d.</span> We may
                      refuse to store, provide, or otherwise maintain your User
                      Content for any or no reason. We may remove your User
                      Content from the Services at any time if you violate these
                      Terms and/or{" "}
                      <a
                      ...
                      Content is stored using the Services with an expiration
                      date, we may also delete the User Content as of that date.
                      User Content that is deleted may be irretrievable. You
                      agree that we have no responsibility or liability for the
                      deletion or failure to store any User Content or other
                      communications maintained or transmitted through use of
                      the Services.
                    </p>
                    <p className="py-4">
                      <span className="font-displaySemibold">e.</span> We
                      reserve the right (but shall have no obligation) to
                      monitor and remove User Content from the Services, at our
                      discretion. You agree to immediately take down any User
                      Content that violates these Terms, including pursuant to a
                      takedown request from us. We also reserve the right to
                      directly take down such User Content.
                    </p>
                    <p className="py-4">
                      <span className="font-displaySemibold">f.</span> You shall
                      own and retain all right, title and interest in and to
                      your User Content. By submitting, posting or otherwise
                      uploading User Content on or through the Services you give
                      GeekyAnts Inc. a worldwide, non-exclusive, perpetual,
                      fully sub-licensable, royalty-free right and license to
                      use, disclose or share the User Content to the extent
                      necessary to provide the Services to you and to protect
                      the Services and from third party fraud, illegal
                      activities, malware, malicious files or content, viruses
                      and the like. In addition to this, you also acknowledge
                      and agree that our third party service providers may also
                      use, disclose and share your User Content solely to the
                      extent necessary to provide the Services to you.
                      Otherwise, we will not sell, disclose, or share any of
                      your User Content (or any part or product thereof) with
                      anyone else. We will implement and maintain reasonable
                      information security policies and processes (including
                      technical, administrative and physical safeguards) that
                      are designed to prevent unauthorized access to or use or
                      disclosure of the Services or any of your User Content.
                    </p>
                  </Text>
                </div>
              </li>
                ...
                <Text style="ml-4 dark:text-white">
                  ...
                  <p className="ml-8">
                    <ul className="list-decimal ">
                      ...
                      <li className="py-4">
                        You shall not attempt to undermine the security or
                        integrity of computing systems or networks of GeekyAnts
                        Inc., its parent company, group companies, affiliates,
                        partners, or any other person, and must not attempt to
                        gain unauthorized access.
                      </li>
                      <li className="py-4">
                        The network resources of GeekyAnts may not be used to
                        impersonate another person or misrepresent authorization
                        to act on behalf of others or us.
                      </li>
                      <li className="py-4">
                        You must not introduce software or automated agents or
                        scripts into our Services in order to produce multiple
                        accounts, generate automated searches, requests or
                        queries, or to strip or mine content or data.
                      </li>
                      <li className="py-4">
                        You must not access our Services through automated
                        methods, including any use of robots or other computer
                        code which calls our website.
                      </li>
                      <li className="py-4">
                        You shall not send unsolicited messages or use the
                        Services to send unsolicited messages (also known as
                        junk mail or SPAM).
                      </li>
                      <li className="py-4">
                        You shall not use the Services as a remote storage
                        server or for the primary purpose of providing
                        downloadable content.
                      </li>
                      <li className="py-4">
                        You may not rent, lease, loan, or sell access to, or
                        otherwise attempt to transfer any right in our Services
                        (which includes its software and documentation) to a
                        third-party, through framing or any other method.
                      </li>
                      <li className="py-4">
                        You must not interfere with or disrupt the Services or
                        create an undue burden on our Services or the networks
                        or services connected to our website.
                      </li>
                      <li className="py-4">
                        You must not perform any benchmark tests or analyses
                        relating to our Services without express permission of
                        us.
                      </li>
                      <li className="py-4">
                        You shall not use the Services to host any protected
                        health information or information that is subject to the
                  ...
                  <p className="py-4">
                    ...
                    discretion of us. You agree that violations of these Terms
                    by yourself or any person or Entity acting under your
                    account will, in addition to any other remedies including
                    criminal prosecution, result in termination of your access
                    to our Services and removal (taking down) of all projects
                    and deployments. In addition, violation of these terms or
                    any of our policies may result in tracking information being
              ...
              <li>
                ...
                <Text className="ml-4">
                  ...
                  <p className="ml-8 dark:text-white">
                    <ul className="list-decimal ">
                      <li className="py-4">
                        ...
                        otherwise commercially exploit or make the Services
                      ...
                      <li className="py-4">
                        ...
                        relevant to the Services or any software, documentation
                        or data related to the Services (where reverse
                        engineering is permitted by applicable law obtaining
                        such information as is necessary to achieve
                        interoperability with our Services, you must first
                        request such information from us in writing);
                      </li>
                      <li className="py-4">
                        modify, translate, or create derivative works based on
                        the Services (except to the extent expressly permitted
                        by us or authorized within the Services) or otherwise
                        attempt to gain unauthorized access to the Services or
                        its related systems or networks;
                      </li>
                      <li className="py-4">
                        use the Services for time sharing or service bureau
                      ...
                      <li className="py-4">
                        ...
                        rights notices (including copyright notices) of us or
                        our suppliers on or within the Services or
                        documentation;
                      </li>
                      <li className="py-4">
                        violate any applicable laws or regulations (including
                        without limitation in violation of any data, privacy or
                        export control laws) or infringe the rights of any
                        third-party in connection with the use or access of the
                        Services.
                      </li>
                      <li className="py-4">
                        upload, record, publish, post, link to, transmit or
                        distribute User Content, or otherwise utilize the
                        Services in a manner that: (i) advocates, promotes,
                        incites, instructs, informs, assists or otherwise
                        encourages violence or any illegal activities; (ii)
                        infringes or violates the copyright, patent, trademark,
                        service mark, trade name, trade secret, or other
                        intellectual property rights of any third party or
                        GeekyAnts Inc. including its parent company, group
                        companies and affiliates, or any rights of publicity or
                        privacy of any party; (iii) attempts to mislead others
                        about your identity or the origin of a message or other
                        communication, or impersonates or otherwise
                        misrepresents your affiliation with any other person or
                        entity, or is otherwise materially false, misleading, or
                        inaccurate; (iv) promotes, solicits or comprises
                        inappropriate, harassing, abusive, profane, hateful,
                        defamatory, libelous, threatening, obscene, indecent,
                        vulgar, pornographic or otherwise objectionable or
                        unlawful content or activity; (v) is harmful to minors;
                        (vi) utilizes or contains any viruses, Phishing attacks,
                        Trojan horses, worms, time bombs, or any other similar
                        software, data, or programs that may damage,
                        detrimentally interfere with, surreptitiously intercept,
                        or expropriate any system, data, personal information,
                        or property of another; or (vii) violates any law,
                        statute, ordinance, or regulation (including without
                        limitation the laws and regulations governing export
                        control, unfair competition, anti-discrimination, or
                        false advertising).
                      </li>
                      <li className="py-4">
                        You may not use the Services if you are a person barred
                        from receiving the Services under the laws of the United
                        States or other countries, including the country in
                  ...
                  <p className="py-4">
                    ...
                    the Services, and you shall promptly notify us if you learn
                    of a security breach or issue related to the Services.
                    Without limiting the foregoing, you acknowledge that we may
                    establish general practices and limits concerning use of the
                    Services, including without limitation the maximum period of
                    time that data, code or other content will be retained by
                    the Services, the maximum storage space that will be
                    allotted on our servers on your behalf, and the maximum
                    compute capacity provided for the execution of builds and
                    functions and the maximum network data transferred by the
                    Services. You further acknowledge that we reserve the right
                  ...
                  <Text className="ml-8">
                    <ul className="list-decimal ">
                      <li className="py-4">
                        ...
                        plan or discontinue offering the free plan at any time.
                        We reserve the right to disable or remove any project or
                        website deployment on the free plan with or without
                        notice at our sole discretion. We may shut down and
                        terminate projects or deployments using the free plan
                        without notice for any reason or no reason. We may shut
                        down affected projects or deployments on the free plan
                        in case of any delays or performance problems including,
                      ...
                      <li className="py-4">
                        ...
                        All information relating the paid plans and pricing
                        terms will be updated in the following versions of these
                        Terms once the Paid Plans are launched by us.
                      </li>
                    </ul>
                  </Text>
                </Text>
              ...
              <li>
                ...
                <p className="ml-4 dark:text-white">
                  <p className="py-4">
                    ...
                    this Agreement, without any third-party consents or
                  ...
                  <p className="ml-8">
                    <ul className="list-decimal ">
                      <li className="py-4">
                        ...
                        permissions, releases, rights or licenses required to
                        engage in posting and other activities (and allow us to
                        perform its obligations) in connection with the Services
                        without obtaining any further releases or consents;
                      </li>
                      <li className="py-4">
                        the User Content and other activities in connection with
                        the Services, and our exercise of all rights and license
                        granted by you herein, do not and will not violate,
                        infringe, or misappropriate any third party's copyright,
                        trademark, right of privacy, or publicity, or other
                        personal or proprietary right and Your Content is not
                        defamatory, obscene, unlawful, threatening, abusive,
                        tortious, offensive or harassing;
                      </li>
                      <li className="py-4">
                        you will use the Services only in compliance with our
                ...
                <p className="ml-4 dark:text-white">
                  ...
                  <p className="ml-8">
                    <ul className="list-decimal dark:text-white ">
                      ...
                      <li className="py-2">Netherlands</li>
                      <li className="py-2">Finland</li>
                      <li className="py-2">England</li>
                      <li className="py-2">Austria</li>
                      <li className="py-2">Singapore</li>
                      <li className="py-2">United Kingdom</li>
                ...
                <div className="py-4 ml-8">
                  <Text>
                    <p>
                      ...
                      not be inactively held for future use. Inactive accounts
                      may be renamed or removed by our staff at their
                      discretion. Keep in mind that not all activity on our
                      Service Platform is publicly visible. Attempts to sell,
                      buy, or solicit other forms of payment in exchange for
                      account names are prohibited and may result in permanent
                      account suspension.
                    </p>
                    <p className="py-4">
                      <span className="font-displaySemibold">b.</span>{" "}
                      ...
                      *.gluestack.app domain names, and these domain names may
                      not be inactively held for future use. Inactive
                      registrations may be renamed or removed by our staff at
                      their discretion. Keep in mind that not all activity on
                      our Service Platformis publicly visible. Attempts to sell,
                      buy, or solicit other forms of payment in exchange for
                      account names are prohibited and may result in permanent
                      account suspension.
                    </p>
                ...
                <div className="py-4 ml-4">
                  <Text>
                    <p>
                      ...
                      receive reports of trademark policy violations from
                      holders of federal or international trademark
                      registrations, we review the account and may take the
                      following actions:
                    </p>
                    <ul className="ml-8 list-decimal">
                      <li className="py-4">
                        When there is a clear intent to mislead others through
                        the unauthorized use of a trademark, we will suspend the
                      ...
                      <li className="py-4">
                        ...
                        confusion. We may also release the username or user id,
                        deployment URL, for the trademark holder’s active use.
                      </li>
                    </ul>
                  </Text>
                </div>
                ...
                <div className="py-4 ml-8">
                  <Text>
                    <p>
                      ...
                      and the resolution of any disputes shall be governed by
                ...
                <div className="py-4 ml-4">
                  <Text>
                    <p>
                      ...
                      You acknowledge that these Terms are a contract between
                      you and us, even though it is electronic and is not
                      physically signed by you and us, and it governs your use
                      of the Services.
                    </p>
                    <p className="py-4">
                      <span className="font-displaySemibold">
                        b. Arbitration: Please read the following Section
                        carefully because it requires you to arbitrate certain
                        disputes and claims with us and limits the manner in
                    ...
                    <ul className="ml-8 list-decimal">
                      <li className="py-4">
                        ...
                        regard to its conflict of laws provisions. Except for
                        small claims disputes in which you or GeekyAnts Inc.,
                        seek to bring an individual action in small claims court
                        located in the county of your billing address or claims
                        for injunctive relief by either party, any dispute or
                        controversy arising out of, in relation to, or in
                        connection with these Terms or your use of the Services
                        shall be finally settled by binding arbitration in San
                        Francisco, California under the Federal Arbitration Act
                        **** (9 U.S.C. §§ 1-307) and the then current rules of
                        JAMS (formerly known as Judicial Arbitration & Mediation
                        Services) by one (1) arbitrator appointed in accordance
                        with such rules. Where arbitration is not required by
                        these Terms, the exclusive jurisdiction and venue of any
                        action with respect to the subject matter of these Terms
                        will be the state and federal courts located in Santa
                        Clara, California, and each of the parties hereto waives
                    ...
                    <p className="py-4">
                      ...
                      ANY DISPUTE RESOLUTION PROCEEDING ARISING OUT OF OR
                      RELATED TO THESE TERMS OR THE SALES TRANSACTIONS BETWEEN
                      YOU AND US, WHETHER IN ARBITRATION OR OTHERWISE, SHALL BE
                      CONDUCTED ONLY ON AN INDIVIDUAL BASIS AND NOT IN A CLASS,
                      CONSOLIDATED OR REPRESENTATIVE ACTION, AND YOU EXPRESSLY
                      AGREE THAT CLASS ACTION AND REPRESENTATIVE ACTION
                      PROCEDURES SHALL NOT BE ASSERTED IN NOR APPLY TO ANY
                      ARBITRATION PURSUANT TO THESE TERMS AND CONDITIONS. YOU
                      ALSO AGREE NOT TO BRING ANY LEGAL ACTION, BASED UPON ANY
                      LEGAL THEORY INCLUDING CONTRACT, TORT, EQUITY OR
                      OTHERWISE, AGAINST US THAT IS MORE THAN ONE YEAR AFTER THE
                    ...
                    <p className="py-4">
                      ...
                      to monitor disputes between you and other Users. We shall
                ...
                <div className="py-4 ml-4">
                  <Text>
                    <p>
                      ...
                      transmissions over various networks; (b) changes to
                      conform and adapt to technical requirements of connecting
                      networks or devices and (c) transmission to our
                      third-party vendors and hosting partners to provide the
                      necessary hardware, software, networking, storage, and
                      related technology required to operate and maintain the
                      Services. Accordingly, you acknowledge that you bear sole
                      responsibility for adequate security, protection and
                      backup of the User Content. We will have no liability to
                      you for any unauthorized access or use of any of the User
                      Content that is attributable, in whole or in part, to an
                      insecurity in your website or project, malware or
                      malicious content in your website or project, or any
                      corruption, deletion, destruction or loss of any the User
                      Content.
                    </p>
                  </Text>
                </div>
                ...
                <div className="py-4 ml-4">
                  <Text>
                    <p>
                      ...
                      Inc., is constantly innovating in order to provide the
                      best possible experience for its users. You acknowledge
                      and agree that the form and nature of the Services which
                      we provide may change from time to time without prior
                      notice to you, subject to the terms in its{" "}
                      <a
                        href="https://gluestack.io/privacy-policy"
                      ...
                      effective with respect to all versions of the Services;
                      examples of changes to the form and nature of the Services
                      include without limitation changes to fee and payment
                      policies, security patches, added functionality, automatic
                      updates, and other enhancements. Any new features that may
                      be added or modified or removed from the Services from
                      time to time will be subject to these Terms, unless stated
                      otherwise.
                    </p>
                    <p className="py-4">
                      <span className="font-displaySemibold">b.</span> You may
                      terminate these Terms at any time by canceling your
                      account on the Services.
                    </p>
                    <p className="py-4">
                      <span className="font-displaySemibold">c.</span> You agree
                      that GeekyAnts Inc., in its sole discretion and for any or
                      no reason, may terminate your account or any part thereof.
                      You agree that any termination of your access to the
                      Services may be without prior notice, and you agree that
                      GeekyAnts Inc., will not be liable to you or any third
                      party for such termination.
                    </p>
                    <p className="py-4">
                      <span className="font-displaySemibold">d.</span> You are
                      solely responsible for exporting your User Content from
                      the Services prior to termination of your account for any
                      reason, provided that if we terminate your account for our
                      convenience, we will endeavor to provide you a reasonable
                      opportunity to retrieve your User Content.
                    </p>
                    <p className="py-4">
                      <span className="font-displaySemibold">e.</span> Upon any
                      termination of the Services or your account these Terms
                      will also terminate, but all provisions of these Terms
                ...
                <div className="py-4 ml-8">
                  <Text>
                    <p>
                      ...
                      Terms may be amended or updated from time to time without
                      notice and may have changed since your last visit to the
                      website or use of the Services. It is your responsibility
                      to review these Terms for any changes. By continuing to
                      access or use the Services after revisions become
                      effective, you agree to be bound by the revised Terms. If
                      you do not agree to the new Terms, please stop using the
                      Services. Please visit this page regularly to review the
              ...
              <li>
                ...
                <div className="py-4 ml-8">
                  <Text>
                    <p>
                      <span className="font-displaySemibold">a.</span> These
                      Services are provided in accordance with our{" "}
                      <a
                        href="https://gluestack.io/privacy-policy"
                        className="text-primary font-displaySemibold"
                      >
                      ...
                      data/information in accordance with these Terms and
                      Privacy Policy.
                    </p>
                  </Text>
                </div>
                ...
                <div className="py-4 ml-8">
                  <Text>
                    <p>
                      ...
                      in this Terms shall be deemed to confer any third-party
                      rights or benefits.
                    </p>
                  </Text>
                </div>
                ...
                <div className="py-4 ml-8">
                  <Text>
                    <p>
                      ...
                      GeekyAnts Inc. or its representatives provides you with a
                      translation of the English language version of these
                      Terms, the English language version of these Terms will
                      prevail over any other language version in case of any
                      conflict.
                    </p>
                    <p>
                      <span className="font-displaySemibold">b.</span> If any
                      part of the Terms of Service is held to be unlawful, void,
                      or unenforceable, that part shall be deemed severed and
                      shall not affect the validity and enforceability of the
                      remaining provisions.
                    </p>
                    <p>
                      <span className="font-displaySemibold">c.</span> The
                      failure of GeekyAnts Inc. to exercise or enforce any right
                      or provision under these Terms shall not constitute a
                      waiver of such right or provision. Any waiver of any right
                      or provision by GeekyAnts Inc. must be in writing and
                      shall only apply to the specific instance identified in
                      such writing.
                    </p>
                    <p>
                      <span className="font-displaySemibold">d.</span> You may
                      not assign these Terms, or any rights or licenses granted
                      hereunder, whether voluntarily, by operation of law, or
                      otherwise without our prior written consent.
                    </p>
                    <p>
                      <span className="font-displaySemibold">e.</span> By using
                      the Services, you consent to receiving electronic
                      communications from us. These electronic communications
                      may include notices about applicable Services fees and
                      charges related to the Services and transactional or other
                      information concerning or related to the Services. These
                      electronic communications are part of your relationship
                      with us and you receive them as part of your use of the
                      Services. You agree that any notices, agreements,
                    ...
                    <p>
                      <span className="font-displaySemibold">f.</span> All
                      communications, notices and requests to GeekyAnts Inc., in
                      relation to the Services and the like must be made in
              ...
              <li>
                ...
                <div className="py-4 ml-8">
                  <Text>
                    <p>
                      <span className="font-displaySemibold">a.</span> GeekyAnts
                      Inc., may elect to provide certain Previews from time to
                      time. During the Preview phase, the primary targeted users
                      for our Services are Customers located in the geographic
                      locations of the United States. Notwithstanding anything
                      contained to the contrary in these Terms, Previews are
                      provided "AS-IS", "WITH ALL FAULTS", and "AS AVAILABLE"
                      without warranty, indemnity, support, or other
                      commitments. You acknowledge and agree that Previews are
                      not ready for production usage, and that your use of any
                      Previews is at its sole risk and discretion. We may
                      change, discontinue or terminate your use of Previews at
                      any time without notice. You acknowledge and agree that we
                      may track your activities, your device type, and collect
                      various data, including analytics, about how you use and
                      interact with our Previews.{" "}
                      <span className="font-displaySemibold">"Previews"</span>{" "}
                      means Services, releases, features, or functionality
                      provided for preview, pre-release, evaluation,
