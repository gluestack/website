        ...
        <div className="mt-[1.5px]">
          ...
          >
            <div>
              ...
              <div className="flex text-sm dark:text-gray">
                1.x
                {/* <svg
...
function SearchInput() {
  return (
    <div className="relative flex w-full flex-wrap items-stretch ">
      <span className="z-10 h-full leading-snug font-normal absolute text-center text-black-400 dark:text-gray absolute bg-transparent rounded text-base items-center justify-center w-8 pl-3 py-3 border-transparent">
        <AiOutlineSearch size={21}/>
      </span>
      <input
        type="text"
        placeholder=""
        className="px-3 py-3 relative text-sm border-b border-gray-100  w-full pl-10 text-sm placeholder-gray-700 text-gray-700 block w-full p-2.5 focus:ring-0 focus:ring-offset-0 focus:outline-none focus:ring-0 focus:border-b dark:bg-black-200 dark:text-gray"
      />
    </div>
  );
}
